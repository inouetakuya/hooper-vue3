...
import { nextTick, h, cloneVNode, PropType } from 'vue';
import Emitter from 'tiny-emitter';

declare function getInRange(value: number, min: number, max: number): number;
...
declare function normalizeSlideIndex(index: number, slidesCount: number): number;
declare function normalizeChildren(context: any, slotProps?: {}): any;
...
declare const _default$3: vue.DefineComponent<{
    name: {
        type: PropType<"arrowUp" | "arrowDown" | "arrowRight" | "arrowLeft">;
        required: true;
...
export { Carousel as Hooper, _default$3 as Icon, _default as Navigation, _default$1 as Pagination, _default$2 as Progress, _default$5 as Slide, _default$4 as addonMixin };
